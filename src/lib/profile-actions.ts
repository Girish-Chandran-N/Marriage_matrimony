...
const MatchPreferencesSchema = z.object({
    ...
    preferredProfessions: z.string().optional(),
    nativeCountry: z.string().optional(),
    nativeState: z.string().optional(),
    nativeDistrict: z.string().optional(),
    workingCountry: z.string().optional(),
    workingState: z.string().optional(),
    workingDistrict: z.string().optional(),
...
export async function updateMatchPreferences(prevState: any, formData: FormData) {
    ...
    try {
        const dataToSave = {
            ...
            preferredProfessions: processList(validation.data.preferredProfessions),
            nativeCountry: processList(validation.data.nativeCountry),
            nativeState: processList(validation.data.nativeState),
            nativeDistrict: processList(validation.data.nativeDistrict),
            workingCountry: processList(validation.data.workingCountry),
            workingState: processList(validation.data.workingState),
            workingDistrict: processList(validation.data.workingDistrict),
